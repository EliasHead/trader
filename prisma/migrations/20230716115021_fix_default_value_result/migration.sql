/*
  ...
  - A unique constraint covering the columns `[competition_name]` on the table `competitions` will be added. If there are existing duplicate values, this will fail.
